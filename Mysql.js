...
function deleteRow(tableID,currentRow) {
    ...
    function bindButtons(){
        document.getElementById('data_submit').addEventListener('click', function(event){
          var req = new XMLHttpRequest();
          var payload = {table_data:null};
          payload.table_data = document.getElementById('table_data').value;
          req.open('GET', 'http://flip1.engr.oregonstate.edu:4591/insert?c=' + payload.table_data, true);
